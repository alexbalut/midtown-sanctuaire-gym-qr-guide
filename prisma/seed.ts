...
async function main() {
  console.log("Seeding Midtown Sanctuaire Montréal...");
  ...
  const gym = await prisma.gym.create({
    data: {
      name: "Midtown Sanctuaire Montréal",
  ...
  console.log("   Gym: Midtown Sanctuaire Montréal");
  console.log("   Login: admin@midtown-sanctuaire.demo / demo1234");
