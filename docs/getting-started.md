...
```bash
git clone https://github.com/alexbalut/midtown-sanctuaire-gym-qr-guide.git
...
Credentials: `admin@midtown-sanctuaire.demo` / `demo1234`
...
Seed **wipes** gyms, users, machines, and issues, then recreates Midtown Sanctuaire Montréal with 10 machines and sample issues/views.
